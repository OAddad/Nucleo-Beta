      ...
      `}>
        ...
        <nav className="flex-1 p-3 lg:p-4 space-y-1.5 lg:space-y-1 overflow-y-auto overflow-x-hidden">
          ...
          <div>
            ...
            >
              <DollarSign className="w-6 h-6 lg:w-5 lg:h-5 flex-shrink-0" strokeWidth={1.5} />
              {sidebarOpen && (
                <>
                  <span className="text-base lg:text-sm flex-1 text-left">{salesModule.label}</span>
                  {salesExpanded ? (
                    <ChevronDown className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
                  ) : (
                    <ChevronRight className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
          ...
          <div>
            ...
            >
              <Users className="w-6 h-6 lg:w-5 lg:h-5 flex-shrink-0" strokeWidth={1.5} />
              {sidebarOpen && (
                <>
                  <span className="text-base lg:text-sm flex-1 text-left">{clientesFornecedoresModule.label}</span>
          ...
          <div>
            ...
            >
              <Wallet className="w-6 h-6 lg:w-5 lg:h-5 flex-shrink-0" strokeWidth={1.5} />
              {sidebarOpen && (
                <>
                  <span className="text-base lg:text-sm flex-1 text-left">{financeiroModule.label}</span>
                  {financeiroExpanded ? (
                    <ChevronDown className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
                  ) : (
                    <ChevronRight className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
          ...
          <div>
            ...
            >
              <MapPin className="w-6 h-6 lg:w-5 lg:h-5 flex-shrink-0" strokeWidth={1.5} />
              {sidebarOpen && (
                <>
                  <span className="text-base lg:text-sm flex-1 text-left">{localizacaoModule.label}</span>
                  {localizacaoExpanded ? (
                    <ChevronDown className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
                  ) : (
                    <ChevronRight className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
          ...
          <div>
            ...
            >
              <Megaphone className="w-6 h-6 lg:w-5 lg:h-5 flex-shrink-0" strokeWidth={1.5} />
              {sidebarOpen && (
                <>
                  <span className="text-base lg:text-sm flex-1 text-left">{impulsioneVendasModule.label}</span>
          ...
          <div>
            ...
            >
              <Settings className="w-6 h-6 lg:w-5 lg:h-5 flex-shrink-0" strokeWidth={1.5} />
              {sidebarOpen && (
                <>
                  <span className="text-base lg:text-sm flex-1 text-left">{configModule.label}</span>
                  {configExpanded ? (
                    <ChevronDown className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
                  ) : (
                    <ChevronRight className="w-5 h-5 lg:w-4 lg:h-4" strokeWidth={1.5} />
