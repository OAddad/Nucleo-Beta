    ...
    with db_lock:
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS products (
                ...
                simple_photo_url TEXT,
                combo_photo_url TEXT,
                photo_url TEXT,
                recipe TEXT,
                cmv REAL DEFAULT 0,
                profit_margin REAL,
...
def create_product(data: Dict) -> Dict:
    with db_lock:
        ...
        ''', (prod_id, code, data['name'], data.get('description'), data.get('category'),
              ...
              data.get('combo_description'), data.get('simple_description'),
              data.get('simple_photo_url'), data.get('combo_photo_url'), data.get('photo_url'),
...
def update_product(product_id: str, data: Dict) -> Optional[Dict]:
    with db_lock:
        ...
        ''', (data.get('name', current['name']), data.get('description', current.get('description')),
              ...
              data.get('combo_description', current.get('combo_description')), 
              data.get('simple_description', current.get('simple_description')),
              data.get('simple_photo_url', current.get('simple_photo_url')),
              data.get('combo_photo_url', current.get('combo_photo_url')),
